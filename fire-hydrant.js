...
function init() {
    ...
    objLoader.load('models/FireHydrant/FireHydrantMesh.obj', function(object) {
        var mainMesh;
        ...
        mainMesh.material = new THREE.MeshStandardMaterial({
            map: textureLoader.load('models/FireHydrant/fire_hydrant_Base_Color.png'),
            normalMap: textureLoader.load('models/FireHydrant/fire_hydrant_Normal_OpenGL.png'),
            roughnessMap: textureLoader.load('models/FireHydrant/fire_hydrant_Roughness.png'),
            metalnessMap: textureLoader.load('models/FireHydrant/fire_hydrant_Metallic.png'),
            aoMap: textureLoader.load('models/FireHydrant/fire_hydrant_Mixed_AO.png'),
